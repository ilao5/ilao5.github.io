...
var comm_list = [{
	...
	list: [{
		...
		{
			name: "兰客导航",
			url: "http://lackk.com/nav/"
		},
		{
			name: "GitNavi",
			url: "http://www.gitnavi.com/u/judasn/"
		},
		{
			name: "炫猿",
			url: "https://xydh.fun/"
	...
	},
	{
		...
		link: [{
			name: "Chrome插件推荐",
			url: "https://www.gugeapps.net/doc/"
		},
		{
			name: "极简插件",
	...
	},
	{
		...
		{
			name: "Html5Rocks",
			url: "https://www.html5rocks.com/zh/tutorials/"
		},
		{
			name: "虎牙直播",
	...
	},
	{
		...
		link: [{
			name: "资源共享区",
			url: "http://www.gxqu.top/index.htm"
		},{
			name: "小众软件",
...
o(".work-link").css("opacity","1").find(".info").hide().html(a).fadeIn(200).find("ul:nth-child(6)").html(t)})}else o(".work-link").css("opacity","1").find(".info").hide().html(a).fadeIn(200)}function i(o){var t={bkgd:"#ededed",srch:"lookao",schl:"0",prov:"1",univ:"1001"}
...
else if(o(t).hasClass("dogge"))o(".search-form").attr("action","https://www.dogedoge.com/results"),o(".search-keyword").attr({name:"q",placeholder:"多吉 搜索"})
else if(o(t).hasClass("yandex"))o(".search-form").attr("action","https://yandex.com/search"),o(".search-keyword").attr({name:"text",placeholder:"Yandex 搜索"})
